...
//                            </li>';
                        ...
                        $this->_menu .= '
                               <li id="menu_' . $category["code"] . '">
                                    <a href = "' . $category["link"] . '" target="' . $category["target"] . '">
                                        <i class = "' . $category["icone"] . ' fa-fw"></i><span id="menu_texto"> ' . $category['name'] . '</span>
                                        <span class = "fa arrow"></span>
                                    </a>';
                    } else if ($category["sub"] == 1) {
                        $this->_menu .= '
                                <li id="menu_' . $category["code"] . '">
                                    <a href = "' . $category["link"] . '" target="' . $category["target"] . '">
                                        <i class = "' . $category["icone"] . ' fa-fw"></i><span id="menu_texto"> ' . $category['name'] . '</span>
    ...
    public function montaMenu($id_user) {
        ...
        $arrayCategories = array();
        foreach ($menu_esq as $key => $value) {
            $arrayCategories[$value['code']] = array("code" => $value["code"], "parent_id" => $value['root'], "name" => $value['name'], "tipo" => $value["tipo"], "link" => $value["link"], "icone" => $value["icone"], "target" => $value["target"], "sub" => $value["sub"]);
        }
